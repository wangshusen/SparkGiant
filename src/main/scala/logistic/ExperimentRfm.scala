...
object ExperimentRfm {
    def main(args: Array[String]) {
        ...
        var dataTrain: RDD[(Double, Array[Double])] = dataRawTrain.mapPartitions(Kernel.rbfRfm(_, 200, sigmaCovtype))
        var dataTest: RDD[(Double, Array[Double])] = dataRawTest.mapPartitions(Kernel.rbfRfm(_, 200, sigmaCovtype))
